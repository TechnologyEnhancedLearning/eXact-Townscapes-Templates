...
/* harmony export */ });
/* unused harmony exports ITERATE_KEY, customRef, deferredComputed, effect, enableTracking, isReadonly, onScopeDispose, readonly, shallowReadonly, stop, toRef, toRefs, toValue, triggerRef */
...
/* harmony export */ });
/* unused harmony exports Comment, KeepAlive, Suspense, Teleport, Text, assertNumber, callWithErrorHandling, cloneVNode, compatUtils, createHydrationRenderer, createPropsRestProxy, createSlots, defineAsyncComponent, defineEmits, defineExpose, defineModel, defineOptions, defineProps, defineSlots, devtools, guardReactiveProps, handleError, hasInjectionContext, initCustomFormatter, isMemoSame, isRuntimeOnly, isVNode, mergeDefaults, mergeModels, mergeProps, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onRenderTracked, onRenderTriggered, onServerPrefetch, queuePostFlushCb, registerRuntimeCompiler, resolveDirective, resolveFilter, setBlockTracking, setDevtoolsHook, ssrContextKey, ssrUtils, toHandlers, transformVNodeArgs, useAttrs, useModel, useSSRContext, useSlots, version, warn, watchEffect, watchSyncEffect, withAsyncContext, withDefaults, withMemo, withScopeId */
/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7658);
/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _vue_reactivity__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4870);
/* harmony import */ var _vue_shared__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2268);
...
/* harmony export */ });
/* unused harmony exports VueElement, createSSRApp, defineCustomElement, defineSSRCustomElement, hydrate, initDirectivesForSSR, render, useCssModule, vModelDynamic, vModelRadio, vModelSelect, vModelText */
/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7658);
/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _vue_shared__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2268);
...
function createInvoker(initialValue, instance) {
  const invoker = e => {
    ...
    (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__/* .callWithAsyncErrorHandling */ .$d)(patchStopImmediatePropagation(e, invoker.value), instance, 5, [e]);
  };
...
function useCssVars(getter) {
  ...
  (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__/* .watchPostEffect */ .Rh)(setVars);
  (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__/* .onMounted */ .bv)(() => {
    const ob = new MutationObserver(setVars);
    ob.observe(instance.subTree.el.parentNode, {
      childList: true
    });
    (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__/* .onUnmounted */ .Ah)(() => ob.disconnect());
  });
}
function setVarsOnVNode(vnode, vars) {
  ...
  } else if (vnode.type === _vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__/* .Fragment */ .HY) {
    vnode.children.forEach(c => setVarsOnVNode(c, vars));
  } else if (vnode.type === _vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__/* .Static */ .qG) {
    let {
      el,
      anchor
    } = vnode;
...
const TransitionPropsValidators = Transition.props = /* @__PURE__ */(0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__/* .extend */ .l7)({}, _vue_runtime_core__WEBPACK_IMPORTED_MODULE_2__/* .BaseTransitionPropsValidators */ .nJ, DOMTransitionPropsValidators);
const callHook = (hook, args = []) => {
...
const hasExplicitCallback = hook => {
  return hook ? (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__/* .isArray */ .kJ)(hook) ? hook.some(h2 => h2.length > 1) : hook.length > 1 : false;
};
...
/* harmony export */ });
/* unused harmony exports NavigationFailureType, RouterLink, RouterView, START_LOCATION, createMemoryHistory, createRouterMatcher, createWebHistory, isNavigationFailure, loadRouteLocation, matchedRouteKey, onBeforeRouteLeave, onBeforeRouteUpdate, parseQuery, routeLocationKey, routerKey, routerViewLocationKey, stringifyQuery, useLink, useRoute, useRouter, viewDepthKey */
/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7658);
...
function useLink(props) {
  const router = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .inject */ .f3)(routerKey);
  const currentRoute = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .inject */ .f3)(routeLocationKey);
  const route = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => router.resolve((0,vue__WEBPACK_IMPORTED_MODULE_2__/* .unref */ .SU)(props.to)));
  const activeRecordIndex = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => {
    const {
      matched
    } = route.value;
    const {
  ...
  const isActive = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => activeRecordIndex.value > -1 && includesParams(currentRoute.params, route.value.params));
  const isExactActive = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => activeRecordIndex.value > -1 && activeRecordIndex.value === currentRoute.matched.length - 1 && isSameRouteLocationParams(currentRoute.params, route.value.params));
  function navigate(e = {}) {
    if (guardEvent(e)) {
      return router[(0,vue__WEBPACK_IMPORTED_MODULE_2__/* .unref */ .SU)(props.replace) ? 'replace' : 'push']((0,vue__WEBPACK_IMPORTED_MODULE_2__/* .unref */ .SU)(props.to)
  ...
  return {
    route,
    href: (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => route.value.href),
    isActive,
    isExactActive,
    navigate
  };
}
const RouterLinkImpl = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_1__/* .defineComponent */ .aZ)({
  name: 'RouterLink',
  compatConfig: {
    MODE: 3
  },
  ...
  setup(props, {
    ...
    const link = (0,vue__WEBPACK_IMPORTED_MODULE_2__/* .reactive */ .qj)(useLink(props));
    const {
      options
    } = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .inject */ .f3)(routerKey);
    const elClass = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => ({
...
const RouterViewImpl = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_1__/* .defineComponent */ .aZ)({
  name: 'RouterView',
  ...
  setup(props, {
    ...
    slots
     ...
     false && 0;
    const injectedRoute = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .inject */ .f3)(routerViewLocationKey);
    const routeToDisplay = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => props.route || injectedRoute.value);
    const injectedDepth = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .inject */ .f3)(viewDepthKey, 0);
    // The depth changes based on empty components option, which allows passthrough routes e.g. routes with children
    // that are used to reuse the `path` property
    const depth = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => {
      let initialDepth = (0,vue__WEBPACK_IMPORTED_MODULE_2__/* .unref */ .SU)(injectedDepth);
      const {
        matched
    ...
    const matchedRouteRef = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => routeToDisplay.value.matched[depth.value]);
    (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .provide */ .JJ)(viewDepthKey, (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => depth.value + 1));
    (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .provide */ .JJ)(matchedRouteKey, matchedRouteRef);
    (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .provide */ .JJ)(routerViewLocationKey, routeToDisplay);
    const viewRef = (0,vue__WEBPACK_IMPORTED_MODULE_2__/* .ref */ .iH)();
    // watch at the same time the component instance, the route record we are
    // rendering, and the name
    (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .watch */ .YP)(() => [viewRef.value, matchedRouteRef.value, props.name], ([instance, to, name], [oldInstance, from, oldName]) => {
...
function createRouter(options) {
  ...
  const currentRoute = (0,vue__WEBPACK_IMPORTED_MODULE_2__/* .shallowRef */ .XI)(START_LOCATION_NORMALIZED);
  ...
  function handleScroll(to, from, isPush, isFirstNavigation) {
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .nextTick */ .Y3)().then(() => scrollBehavior(to, from, scrollPosition)).then(position => position && scrollToPosition(position)).catch(err => triggerError(err, to, from));
  }
  ...
  const router = {
    ...
    install(app) {
      ...
      Object.defineProperty(app.config.globalProperties, '$route', {
        enumerable: true,
        get: () => (0,vue__WEBPACK_IMPORTED_MODULE_2__/* .unref */ .SU)(currentRoute)
      });
      ...
      for (const key in START_LOCATION_NORMALIZED) {
        ...
        reactiveRoute[key] = (0,vue__WEBPACK_IMPORTED_MODULE_1__/* .computed */ .Fl)(() => currentRoute.value[key]);
      }
      app.provide(routerKey, router);
      app.provide(routeLocationKey, (0,vue__WEBPACK_IMPORTED_MODULE_2__/* .reactive */ .qj)(reactiveRoute));
